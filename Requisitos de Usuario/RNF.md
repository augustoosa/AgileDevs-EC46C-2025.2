...
| RNF04 |	O sistema deve ser compatível com os sistemas operacionais macOS, Windows e Linux nas suas versões mais recentes. |	Alta |	Todos |
| RNF05	| O sistema deve demorar menos de 2 segundos para fazer qualquer tipo de funcionalidade (abrir nova janela, salvar dados, buscar com filtro) |	Alta	| Todos |
